            ...
            <div className="bg-gradient-to-br from-purple-600 to-indigo-700 p-8 text-white">
              ...
              <div className="space-y-6">
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    ...
                    <p className="text-purple-100">contact@arishya.software</p>
                  </div>
                </div>
                ...
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    ...
                    <p className="text-purple-100">+91 7355158565</p>
                  </div>
                </div>
                ...
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    ...
                    <a 
                      href="https://t.me/ArishyaSoftware" 
                      target="_blank" 
                ...
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    ...
                    <p className="text-purple-100">27AATFA0093N1ZX</p>
                  </div>
                </div>
                ...
                <div className="space-y-2">
                  ...
                  <div className="flex space-x-4">
                    <a
                      href="https://linkedin.com/company/arishyasoftware"
                      target="_blank"
                      rel="noopener noreferrer"
                      className="text-purple-100 hover:text-white transition-colors"
                    >
                    ...
                    <a
                      href="https://facebook.com/ArishyaSoftware"
                      target="_blank"
                      rel="noopener noreferrer"
                      className="text-purple-100 hover:text-white transition-colors"
                    >
                    ...
                    <a
                      href="https://github.com/ArishyaSoftware"
                      target="_blank"
                      rel="noopener noreferrer"
                      className="text-purple-100 hover:text-white transition-colors"
                    >
              ...
              <div className="mt-12">
                ...
                <p className="text-purple-100">
                  302, HARI LEELA, RAM MANDIR ROAD<br />
                  OFF NEHRU ROAD, VILE PARLE EAST<br />
                  Mumbai Suburban, Maharashtra<br />
                  400057
                </p>
              </div>
            </div>
